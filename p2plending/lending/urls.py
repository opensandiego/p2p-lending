...
router.register(r'borrowed-loans', authenticated_views.BorrowedLoanViewSet, 'borrowed-loans' )
router.register(r'owner-loans', authenticated_views.OwnerLoanViewSet, 'owner-loans' )
